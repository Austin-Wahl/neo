...
const AuthenticatedUserLayout = ({
  ...
  return (
    <SidebarProvider>
      ...
      />
      <SidebarInset>
        <header className=" border-b-2 fixed w-full bg-background flex h-16 shrink-0 items-center gap-2 transition-[width,height] ease-linear group-has-[[data-collapsible=icon]]/sidebar-wrapper:h-12">
        ...
        <div className="flex flex-1 flex-col gap-4 p-4 pt-0 mt-20 overflow-y-auto">
          {children}
        </div>
      </SidebarInset>
    </SidebarProvider>
